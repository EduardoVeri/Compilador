...
#line 1612 "arquivo_bison.tab.c"
    break;

  case 19:
#line 172 "arquivo_bison.y"
                                                                                   { 
						if(yyvsp[-2] != NULL){
							yyval = yyvsp[-2];
...
#line 212 "arquivo_bison.y"
                                                       {yyval = yyvsp[0];}
#line 1697 "arquivo_bison.tab.c"
    break;

  case 29:
#line 215 "arquivo_bison.y"
                                              {yyval = yyvsp[-1];}
#line 1703 "arquivo_bison.tab.c"
    break;
