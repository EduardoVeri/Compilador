...
./bin/compilador ./testes/SO/sort.cm -o ./bin/testes_SO/sort.txt -v
...
#./bin/compilador ./testes/SO/soma_funcao.cm -o ./bin/testes_SO/soma_funcao.txt -v -ci -ca
#./bin/compilador ./testes/SO/modulo.cm -o ./bin/testes_SO/modulo.txt

cp -r ./bin/testes_SO/ ./extra/